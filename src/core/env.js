...
const defaults = new Map(
  Object.entries({
    ...
    TLS_PSK: {
      // alias "TOP_SECRET_512_B64"
      // if non-nil, uses sha512 of this static key for TLS PSK for doh/dot
      // if the client identifies itself as 790bb45383670663ce9a39480be2... (see: psk.js)
      // Using TLS_PSK also disables SNI checks (as if TLS_ALLOW_ANY_SNI is true).
      // Dynamic PSK can be generated by calling /gentlspsk which returns a dynamic
      // identity and key pair encoded as hex strings (keys are derived from TLS_PSK)
    ...
    // base URL of this deployment, used to build self-hosted configure/search/DNS URLs.
    // Ex: "https://dns.example.com". When empty, redirects fall back to rethinkdns.com.
    APP_BASE_URL: {
      type: "string",
      default: "",
    },
